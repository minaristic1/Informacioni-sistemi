...
\begin{frame}{Evidencija pregleda i tretmana životinja}
        \begin{figure}[h!]
        \begin{center}
          \includegraphics[scale = 0.35]{SlucajeviUpotrebe/su2.png}
        \end{center}
       \caption{Dijagram slučaja upotrebe}
    \end{figure}   
\end{frame}

\begin{frame}{Unos podataka}
        \begin{figure}[h!]
        \begin{center}
          \includegraphics[scale = 0.29]{Dijagrami/dijagram_aktivnosti_unos_podataka.png}
        \end{center}
        \caption{Unos podataka - Dijagram aktivnosti}
    \end{figure}   
\end{frame}

\begin{frame}{Pregled podataka}
        \begin{figure}[h!]
        \begin{center}
          \includegraphics[scale = 0.3]{Dijagrami/dijagram_aktivnosti_pregled_podataka.png}
        \end{center}
