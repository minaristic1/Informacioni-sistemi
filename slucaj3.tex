...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{dijagram_aktivnosti_kreiranje_narudzbine.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{dijagram_aktivnosti_evidencija_potrosnje.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{dijagram_aktivnosti_prijem_robe.png}
