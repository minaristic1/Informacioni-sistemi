...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{SlucajeviUpotrebe/dijagram3.png}
    \caption{Slučaj upotrebe: Upravljanje zalihama lekova i jednokratnom opremom}
...
\begin{enumerate}
    ...
    \item Veterinar ponavlja korake 2-5 ukoliko ima jos artikala koje je koristio. Ako ih nema, zavrsava unos.
...
\begin{enumerate}
    ...
    \item[A2.]\textbf{Veterinar predlaze novi artikal za narudzbinu} 
        \begin{enumerate}
            ...
            \item[2.] Navodi podatke o lijeku ili opremi koju bi zeleo da bude narucena.
...
\begin{enumerate}
    ...
    \item Menadžer bira artikal koji želi da naruči iz te liste ili druge artikle iz kataloga. Ukoliko zeli da naruci neki novi artikal koji se ne nalazi u katalogu, ide se na alternativni tok A1.
...
\begin{enumerate}
    \item[A1.]\textbf{Artikal koji želi da naruči ne postoji u katalogu}
        ...
        \end{enumerate}
    \item[A2.]\textbf{Narudzbina premasuje budzet}
        \begin{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item[2.] Menadžer evidentira manjak  i kontaktira dobavljaca.
    ...
    \begin{enumerate}
        ...
        \item[2.] Menadžer kontaktira dobavlja.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{Dijagrami/dijagram_aktivnosti_kreiranje_narudzbine.png}
    \caption{Dijagram aktivnosti - Kreiranje narudzbine}
    \label{fig:placeholder}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{Dijagrami/dijagram_aktivnosti_evidencija_potrosnje.png}
    \caption{Dijagram aktivnosti - Evidencija potrosnje}
    \label{fig:placeholder}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{Dijagrami/dijagram_aktivnosti_prijem_robe.png}
