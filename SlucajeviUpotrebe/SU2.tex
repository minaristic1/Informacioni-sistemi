...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{SlucajeviUpotrebe/su2.png}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Ponavlja se korak (1.) glavnog toka.
    \end{enumerate}
    \item[A3.]\textbf{Neki od rezultata nisu dostupni} Ukoliko neke analize o životinji nisu trenutno dostupne, sistem omogućava naknadni unos.
\end{enumerate}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{Dijagrami/dijagram_aktivnosti_unos_podataka.png}
    \caption{Dijagram aktivnosti: Unos podataka o životinji}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{Dijagrami/dijagram_aktivnosti_pregled_podataka.png}
    \caption{Dijagram aktivnosti: Pregled podataka o životinji}
    \label{fig:placeholder}
\end{figure}
